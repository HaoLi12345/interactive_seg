...
class Unet_decoder(nn.Module):
    def __init__(
        ...
        self.upcat_2 = UpCat(spatial_dims, fea[2], fea[1], fea[1], act, norm, bias, dropout, upsample, halves=False)
    ...
    def forward(self, image_embeddings, feature_list):
        ...
        x4, x3, x2, x1 = image_embeddings, feature_list[2], feature_list[1], feature_list[0]
