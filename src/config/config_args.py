...
# data
parser.add_argument("--data", default='colon', type=str, choices=["kits", "pancreas", "lits", "colon"])
parser.add_argument("--save_dir", default="./implementation/", type=str)
parser.add_argument("--data_dir", default="/home/hao/Desktop/3D_val_npz", type=str)
parser.add_argument("--label_dir", default="/home/hao/Desktop/3D_val_gt_interactive_seg", type=str)
parser.add_argument("--num_workers", default=2, type=int)
parser.add_argument("--split", default="train", type=str)
parser.add_argument("--split_path", default="/home/hao/Hao/CVPR2025_interactive_challenge/src/useful_scripts/split_full.json", type=str)
...
parser.add_argument("--iter_weight", action="store_true")


parser.add_argument('--iter_nums', type=int, default=6)
